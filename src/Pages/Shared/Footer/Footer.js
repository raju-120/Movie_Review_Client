...
const Footer = () => {
    return (
        <div>
            <footer class="bg-white dark:bg-gray-900 rounded mt-5">
                <div class="grid grid-cols-2 gap-8 px-6 py-8 md:grid-cols-4 rounded">
                    <div>
                        <h2 class="mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">Company</h2>
                        <ul class="text-gray-500 dark:text-gray-400 rounded-lg">
                            <li class="mb-4">
