...
const Footer = () => {
    return (
        <div>
            <footer className="bg-white dark:bg-gray-900 rounded mt-5">
                <div className="grid grid-cols-2 gap-8 px-6 py-8 md:grid-cols-4 rounded">
                    <div>
                        <h2 className="mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">Company</h2>
                        <ul className="text-gray-500 dark:text-gray-400 rounded-lg">
                            <li className="mb-4">
                ...
                <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between rounded-xl">
                    <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 All Rights Reserved to hakunama-tata.
                    </span>
